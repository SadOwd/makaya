...
const HomePage = ({ onNavigate }) => {
  const branches = [
    ...
    },
    {
      ...
      description: 'Vente de véhicules électriques, Location Longue Durée et Service Après-Vente complet pour une expérience d’électromobilité fiable et sans contraintes.',
      stats: [
    ...
    },
    {
      ...
      description: 'Infrastructure de recharge électrique en pleine expansion au TOGO, offrant un réseaau fiable et rapide pour une mobilité moderne et durable.',
      stats: [
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 rounded-2xl border border-slate-700/50 backdrop-blur-xl p-8">
